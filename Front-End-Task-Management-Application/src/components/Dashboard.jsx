...
const Dashboard = () => {
  ...
  const fetchTasks = async () => {
    try {
      const res = await axios.get(`${API_BASE}/getAllTasks`, { headers: authHeader() });
    ...
    if (editingId) {
      ...
      (async () => {
        try {
          ...
          await axios.put(`${API_BASE}/updateTask`, payload, { headers: authHeader() });
      ...
      (async () => {
        try {
          ...
          await axios.post(`${API_BASE}/saveTask`, payload, { headers: authHeader() });
      ...
      buttons: [
        {
          ...
          onClick: async () => {
            try {
              await axios.delete(`${API_BASE}/deleteTask/${id}`, { headers: authHeader() });
        ...
        <div className="dashboard-header">
          ...
          <div className="controls">
            <div className="user-controls">
              <div className="welcome-text">Logged in as {localStorage.getItem('email') || 'User'}</div>
